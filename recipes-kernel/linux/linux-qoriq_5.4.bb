# nooelint: oelint.var.mandatoryvar.SUMMARY oelint.var.mandatoryvar.DESCRIPTION oelint.var.mandatoryvar.LICENSE
# SUMMARY, DESCRIPTION and LICENSE come from meta-freescale's linux-qoriq.inc,
# required below. oelint cannot follow a require into another layer, so it sees
# them as unset; restating them here would duplicate values meta-freescale owns.
